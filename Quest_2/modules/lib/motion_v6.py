...
class motion_v6():    
    ...
    def init(self):
        ...
        self.setFME(False)
        self.setBackgroundMovement(True)
    ...
    def backToStand(self):
        ...
        self.globals.motProxy.setStiffnesses("Head",0.6)
    ...
    def bellyToStand(self):
        ...
        time.sleep(2.0)
        self.globals.motProxy.setStiffnesses("Head",0.0)#TBC
    ...
    def changeHead(self, yaw,pitch):
        self.globals.motProxy.setStiffnesses("Head",0.9)
        self.globals.motProxy.changeAngles(['HeadYaw', 'HeadPitch'], [yaw, pitch], 0.1)
        time.sleep(2.0)
        self.globals.motProxy.setStiffnesses("Head",0.6)
    ...
    def setHead(self, yaw, pitch):
        self.globals.motProxy.setStiffnesses("Head",0.9)
        self.globals.motProxy.setAngles(["HeadYaw", "HeadPitch"], [yaw, pitch], 0.1)    
        time.sleep(2.0)
        self.globals.motProxy.setStiffnesses("Head",0.6)
